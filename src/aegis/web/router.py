...
# /funders/* (list / new / import / detail / submit-modal / reextract-modal /
# reextract / operator-notes) moved to aegis.web.routers.funders during
# R4.1. Aggregator include_router wires the sub-router in at the top of
# this file. The shared form-parsers (_decimal_or_none / _int_or_none /
# _sha256_hex) moved to aegis.web._router_helpers so the still-resident
# merchants routes keep consuming the same code paths.
...
# _sha256_hex lifted to aegis.web._router_helpers during R4.1 — consumed
# by both the funders re-extract route and the merchants submit-to-funders
# audit row. Imported back below.
...
# _decimal_or_none + _int_or_none lifted to aegis.web._router_helpers
# during R4.1 — consumed by both the funders sub-router and the still-
# resident merchants funder-response route. Imported back below.


# _parse_tiers_json, _parse_bullet_lines, _TRUE_TOKENS, _parse_csv_list,
# _FUNDER_FORM_FIELDS, _funder_form_dict_from_locals, _funder_form_error
# moved to aegis.web.routers.funders during R4.1 alongside the funder
# routes that consume them. They were never imported by any test.
